...
# For:  Generate maltego scripts to plot Domains created by a registrant
#
#
# Usage: Source registrant, output c2_domains
...
def main():
    ...
    if found1 is not None:
        ...
        c.execute("SELECT * FROM passive_whois where registrant=?", ((registrant),))
        found2 = c.fetchall()
